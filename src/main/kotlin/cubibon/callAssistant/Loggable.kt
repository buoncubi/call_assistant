...
class CentralizedLogger(clazz: Class<out LoggableInterface>, private val slf4jLogger: Logger) {
    ...
    /**
     * Returns `slf4jLogger.isTraceEnabled`.
     * @return `true` if this logger pringts `TRACE` level messages; `false` otherwise.
     */
    fun isTraceEnabled() = slf4jLogger.isTraceEnabled


    /**
     * Returns `slf4jLogger.isDebugEnabled`.
     * @return `true` if this logger pringts `DEBUG` level messages; `false` otherwise.
     */
    fun isDebugEnabled() = slf4jLogger.isDebugEnabled


    /**
     * Returns `slf4jLogger.isInfoEnabled`.
     * @return `true` if this logger pringts `INFO` level messages; `false` otherwise.
     */
    fun isInfoEnabled() = slf4jLogger.isInfoEnabled


    /**
     * Returns `slf4jLogger.isWarnEnabled`.
     * @return `true` if this logger pringts `WARN` level messages; `false` otherwise.
     */
    fun isWarnEnabled() = slf4jLogger.isWarnEnabled


    /**
     * Returns `slf4jLogger.isErrorEnabled`.
     * @return `true` if this logger pringts `ERROR` level messages; `false` otherwise.
     */
    fun isErrorEnabled() = slf4jLogger.isErrorEnabled
}
