...
class AwsMessagesManagerTest {
    ...
    fun simpleExample() {
        ...
        userMessage?.metadata?.addTiming(MetaTiming.SPEECH_START, System.currentTimeMillis())
    ...
    fun testMetadata() {
        ...
        metaMessageA5?.metadata?.addTiming(MetaTiming.SPEECH_END, System.currentTimeMillis())

        metaMessageU5?.metadata?.addTiming(MetaTiming.SPEECH_START, System.currentTimeMillis())
